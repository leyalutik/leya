...
//ћатрица закручиваетс€ по спирали слева направо, сверху вниз.
//ћатрица заранее проинициализирована €чейками в пор€дке возрастани€
//Ќа выходе выдаетс€ последовательноть прохождени€ матрицы по спирали.
//измен€€ m и n размеры матрицы мы получаем разные ответы
